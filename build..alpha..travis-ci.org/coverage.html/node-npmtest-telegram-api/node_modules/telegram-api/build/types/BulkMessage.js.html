...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-telegram-api/node_modules/telegram-api/build/types/BulkMessage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-telegram-api/node_modules/telegram-api/build/types/BulkMessage.js</span></h1>
    <h2>
        
        Statements: <span class="metric">57.89% <small>(33 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-telegram-api/node_modules/telegram-api/build/types/</a> &#187; BulkMessage.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function BulkMessage() {</span>
<span class="cstat-no" title="statement not covered" >    var properties = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, BulkMessage);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (BulkMessage.__proto__ || Object.getPrototypeOf(BulkMessage)).call(this, properties));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.chats = [];</span>
...
&nbsp;
  _createClass(BulkMessage, [{
    key: 'to',
    value: <span class="fstat-no" title="function not covered" >function to() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var chats = args.reduce(<span class="fstat-no" title="function not covered" >function (a, b) {</span></span>
<span class="cstat-no" title="statement not covered" >        return a.concat(b);</span>
      }, []);
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.chats = chats;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var promises = this.chats.map(<span class="fstat-no" title="function not covered" >function (chat) {</span></span>
<span class="cstat-no" title="statement not covered" >        var clone = Object.assign({}, _this2.properties);</span>
<span class="cstat-no" title="statement not covered" >        var message = new _Message3.default(clone).to(chat);</span>
<span class="cstat-no" title="statement not covered" >        return message.send(bot);</span>
      });
&nbsp;
