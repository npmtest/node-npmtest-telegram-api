...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-telegram-api/node_modules/telegram-api/build/types/File.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-telegram-api/node_modules/telegram-api/build/types/File.js</span></h1>
    <h2>
        
        Statements: <span class="metric">41.05% <small>(39 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">23.73% <small>(14 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-telegram-api/node_modules/telegram-api/build/types/</a> &#187; File.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    var properties = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, File);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (File.__proto__ || Object.getPrototypeOf(File)).call(this, 'sendDocument'));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.properties = properties;</span>
<span class="cstat-no" title="statement not covered" >    _this._keyboard = new _Base3.default();</span>
...
&nbsp;
  _createClass(File, [{
    key: 'to',
    value: <span class="fstat-no" title="function not covered" >function to(chat) {</span>
<span class="cstat-no" title="statement not covered" >      this.properties.chat_id = chat;</span>
...
&nbsp;
    ...
    key: 'file',
    value: <span class="fstat-no" title="function not covered" >function file(_file, fileType) {</span>
<span class="cstat-no" title="statement not covered" >      if (fileType) {</span>
<span class="cstat-no" title="statement not covered" >        this.properties[fileType] = { file: _file };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _mime$lookup$split = _mime2.default.lookup(_file).split('/'),</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (type === 'image') {</span>
<span class="cstat-no" title="statement not covered" >        type = 'photo';</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (extension === 'gif') {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.properties[type] = { file: _file };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.method = 'send' + (type[0].toUpperCase() + type.slice(1));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
...
&nbsp;
    ...
    key: 'caption',
    value: <span class="fstat-no" title="function not covered" >function caption(text) {</span>
<span class="cstat-no" title="statement not covered" >      this.properties.caption = text;</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'reply',
    value: <span class="fstat-no" title="function not covered" >function reply(id) {</span>
<span class="cstat-no" title="statement not covered" >      this.properties.reply_to_message_id = id;</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'keyboard',
    value: <span class="fstat-no" title="function not covered" >function keyboard(kb) {</span>
<span class="cstat-no" title="statement not covered" >      this._keyboard = kb;</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
