...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-telegram-api/node_modules/telegram-api/build/types/Message.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-telegram-api/node_modules/telegram-api/build/types/Message.js</span></h1>
    <h2>
        
        Statements: <span class="metric">50.77% <small>(33 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">31.11% <small>(14 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-telegram-api/node_modules/telegram-api/build/types/</a> &#187; Message.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Message);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Message.__proto__ || Object.getPrototypeOf(Message)).call(this, 'sendMessage'));</span>
&nbsp;
...
&nbsp;
    ...
    key: 'text',
    value: <span class="fstat-no" title="function not covered" >function text(_text) {</span>
<span class="cstat-no" title="statement not covered" >      this.properties.text = _text;</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'html',
    value: <span class="fstat-no" title="function not covered" >function html(text) {</span>
<span class="cstat-no" title="statement not covered" >      this.properties.parse_mode = 'HTML';</span>
...
&nbsp;
    ...
    key: 'markdown',
    value: <span class="fstat-no" title="function not covered" >function markdown(text) {</span>
<span class="cstat-no" title="statement not covered" >      this.properties.parse_mode = 'Markdown';</span>
<span class="cstat-no" title="statement not covered" >      if (text) {</span>
<span class="cstat-no" title="statement not covered" >        this.properties.text = text;</span>
      }
<span class="cstat-no" title="statement not covered" >      return this;</span>
...
&nbsp;
    ...
    key: 'preview',
    value: <span class="fstat-no" title="function not covered" >function preview() {</span>
<span class="cstat-no" title="statement not covered" >      var enable = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.properties.disable_web_page_preview = !enable;</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
